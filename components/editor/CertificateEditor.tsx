...
export default function CertificateEditor() {
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-50">
      {/* Top Header Mode Switcher */}
      <header className="z-20 flex h-14 flex-shrink-0 items-center justify-between border-b border-neutral-200 bg-white px-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
        <div className="flex items-center gap-6">
          ...
          >
            <TabsList className="h-9">
              <TabsTrigger value="generator" className="px-4 text-xs">
                Generator Hub
              </TabsTrigger>
              <TabsTrigger value="email" className="px-4 text-xs">
                Email Distributor
              </TabsTrigger>
            </TabsList>
          </Tabs>
      ...
      <div className="flex flex-1 overflow-hidden">
        {appMode === "generator" ? (
                          ...
                          <CardContent className="pt-0">
                            <div className="flex items-center justify-between rounded-lg border border-violet-200 bg-violet-50 px-3 py-2 dark:border-violet-800 dark:bg-violet-950/40">
                              ...
                              <Button
                                ...
                                onClick={goToNextRow}
                                disabled={
                                  previewRowIndex >= excelData.length - 1
                                }
                              >
          ...
          <>
            {/* Email Distributor Mode */}
            <main className="flex flex-1 items-start justify-center overflow-y-auto bg-neutral-100/50 p-8 dark:bg-neutral-950">
              <div className="w-full max-w-6xl">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold tracking-tight text-neutral-800 dark:text-neutral-100">
                    Email Distribution Hub
                  </h2>
                  <p className="mt-1 text-sm text-neutral-500">
                    Configure your message and upload signed certificates to
